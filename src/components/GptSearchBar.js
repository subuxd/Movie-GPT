...
import { addGptSearchView } from "../utils/gptSlice";
...
const GptSearchBar = () => {
  ...
  const handleGptSearchClick = async () => {
    ...
    const gptQuery =
      ...
      ". only give me names of 5 movies, comma separated like the example result give ahead. Example Result: 12th Fail, 3 Idiots, Gadar, Dunki, Fighter";
